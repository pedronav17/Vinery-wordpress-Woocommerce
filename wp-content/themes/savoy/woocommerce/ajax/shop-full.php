...
<?php
    /* Body class */
    $body_class = join( ' ', get_body_class() ); // Code from: https://developer.wordpress.org/reference/functions/body_class/#source
    printf( '<div id="nm-body-class" class="' . esc_attr( $body_class ) . '"></div>', $body_class );
